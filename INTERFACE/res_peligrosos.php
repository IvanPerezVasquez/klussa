        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8 col-md-6 col-12 mb-2">
            <div class="d-flex flex-wrap align-items-center gap-2">
              ...
              <select  name="FK_res" id="cbx_fil_res" class="form-select form-select-sm w-auto">
                <option value="">Código</option>
              </select>

              <select name="FK_t_res" id="cbx_tipo" class="form-select form-select-sm w-auto">
                <option value="">Código</option>
              </select>
       ...
       <table class="table table-hover align-middle mb-0 text-nowrap shadow-sm text-uppercase" id="tabla_res">
          <thead class="text-white" style="background: #212529;">
            <tr>
              ...
              <th scope="col" class="px-3 py-3">FC ENTREGA</th>
              <th scope="col" class="px-3 py-3">CÓDIGO</th>
              <th scope="col" class="px-3 py-3">AGENCIA</th>
              <th scope="col" class="px-3 py-3">CLASIF. RHOMB</th>
              <th scope="col" class="px-3 py-3">GESTORA</th>
